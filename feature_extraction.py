...
# Use relative paths for the workspace
model_path = "hand_landmarker.task"  # Place the model file in the workspace root
dataset_path = "CW2_dataset_final"
output_csv = "hand_landmarks.csv"
output_world_csv = "world_hand_landmarks.csv"
    ...
    with HandLandmarker.create_from_options(options) as landmarker:
        ...
        for folder in sorted(os.listdir(dataset_path)):
            ...
            for filename in os.listdir(folder_path):
                ...
                #processing image
                image = mp.Image.create_from_file(file_path) #type: ignore
